...
exports.ThemeService = exports.TelosLandingTheme = exports.WaxLandingTheme = exports.LightTheme = exports.LiberlandTheme = exports.DefaultTheme = void 0;
...
exports.LiberlandTheme = {
    ...
    '--black-color': '#000000',
    '--gray-dark': '#232323',
    '--gray-darkmedium': '#404040',
    '--gray-medium': '#585858',
    '--gray-lightmedium': '#adadad',
    '--gray-light': '#D6D6D6',
    '--red-color': '#ff4237',
    /*concepts*/
...
let ThemeService = class ThemeService {
    ...
    defaultTheme() {
        ...
        this.setTheme(exports.DefaultTheme);
    }
    lightTheme() {
        this.currentTheme = 'light';
        this.setTheme(exports.LightTheme);
    }
    liberlandTheme() {
        this.currentTheme = 'liberland';
        this.setTheme(exports.LiberlandTheme);
    }
    waxTheme() {
        this.currentTheme = 'wax';
        this.setTheme(exports.WaxLandingTheme);
    }
    telosTheme() {
        this.currentTheme = 'telos';
        this.setTheme(exports.TelosLandingTheme);
    }
    setTheme(theme) {
