...
var EOSJSService = /** @class */ (function () {
    ...
    EOSJSService.prototype.getConstitution = function () {
        var _this = this;
        this.eos['getCode']('eosio').then(function (code) {
            var temp = code['abi']['ricardian_clauses'][0]['body'];
                                ...
                                _this.eos['contract'](contract, function (err, tokenContract) {
                                    if (!err) {
                                        if (tokenContract['transfer']) {
                                            tokenContract['transfer'](from, to, amount, memo, function (err2, trx) {
                                                console.log(err, trx);
                                                if (err2) {
    ...
    EOSJSService.prototype.ramBuyBytes = function (payer, receiver, bytes) {
        return this.eos.buyrambytes(payer, receiver, bytes);
    };
    EOSJSService.prototype.ramBuyEOS = function (payer, receiver, quant) {
        return this.eos.buyram(payer, receiver, quant.toFixed(4) + ' EOS');
    };
    EOSJSService.prototype.ramSell = function (account, bytes) {
        return this.eos.sellram(account, bytes);
    };
    EOSJSService.prototype.createAccount = function (creator, name, owner, active, delegateAmount, rambytes, transfer, giftAmount, giftMemo) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.auth) {
    ...
    EOSJSService.prototype.voteProducer = function (voter, list) {
        return __awaiter(this, void 0, void 0, function () {
            var currentVotes_1, info, broadcast_lib_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(list.length <= 30)) return [3 /*break*/, 2];
                        currentVotes_1 = list;
                        currentVotes_1.sort();
                        return [4 /*yield*/, this.eos['getInfo']({}).then(function (result) {
                                return result;
                            })];
                    case 1:
                        info = _a.sent();
                        broadcast_lib_1 = info['last_irreversible_block_num'];
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                var cb = function (err, res) {
                                    if (err) {
                                        ...
                                        console.log(res);
                                        setTimeout(function () {
                                            _this.txCheckQueue.push({
                                                block: broadcast_lib_1,
                                                id: res['transaction_id']
                                            });
                                            _this.startMonitoringLoop();
                                        }, 1000);
                                        resolve(res);
                                    }
                                };
                                _this.eosio['voteproducer'](voter, '', currentVotes_1, cb);
                            })];
                    case 2: return [2 /*return*/, new Error('Cannot cast more than 30 votes!')];
                }
            });
        });
    };
    EOSJSService.prototype.stake = function (account, amount) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (amount > 2) {
    ...
    EOSJSService.prototype.unstake = function (account, amount) {
        var _this = this;
        return new Promise(function (resolve, reject) {
