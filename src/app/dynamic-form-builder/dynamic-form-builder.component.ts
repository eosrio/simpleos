...
@Component({
	...
	//box-shadow: 0 3px 1px -2px rgba(0,121,184,.2), 0 2px 2px 0 rgba(0,121,184,.54), 0 1px 5px 0 rgba(0,120,184,.12);
})
export class DynamicFormBuilderComponent implements OnInit, AfterViewInit {
	...
	constructor(public dapp: DappComponent, public eos: EOSJSService,private renderer: Renderer2) {
		this.openSub = false;
	}
