...
export class DashboardComponent implements AfterViewInit, OnDestroy {
    ...
    validOwnerPubKey = false;
    validActivePubKey = false;
    ...
    constructor(
        ...
        this.appVersion = (window as any).appversion;
    ...
    openRemoveAccModal(index, account): void {
